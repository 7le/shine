...
<script src="/static/backend/js/plugins/echarts/echarts-all.js"></script>
<script src="/static/backend/js/content.min.js?v=1.0.0"></script>
<script src="/static/backend/js/demo/echarts-demo.min.js"></script>
