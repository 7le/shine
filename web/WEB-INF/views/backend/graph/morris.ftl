...
<head>
    ...
    <!-- orris -->
    <link href="/static/backend/css/plugins/morris/morris-0.4.3.min.css" rel="stylesheet">
...
<script src="/static/backend/js/plugins/morris/raphael-2.1.0.min.js"></script>
<script src="/static/backend/js/plugins/morris/morris.js"></script>
<script src="/static/backend/js/content.min.js?v=1.0.0"></script>
<script src="/static/backend/js/demo/morris-demo.min.js"></script>
