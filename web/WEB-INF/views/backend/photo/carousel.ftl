                    ...
                    <div class="carousel slide" id="carousel1">
                        <div class="carousel-inner">
                            <div class="item active">
                                <img alt="image" class="img-responsive" src="/static/backend/img/p_big3.jpg">
                            </div>
                            <div class="item">
                                <img alt="image" class="img-responsive" src="/static/backend/img/p_big1.jpg">
                            </div>
                            <div class="item ">
                                <img alt="image" class="img-responsive" src="/static/backend/img/p_big2.jpg">
                            </div>
