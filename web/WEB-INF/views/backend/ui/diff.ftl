...
<script src="/static/backend/js/plugins/diff_match_patch/diff_match_patch.js"></script>
<script src="/static/backend/js/plugins/preetyTextDiff/jquery.pretty-text-diff.min.js"></script>
<script>
