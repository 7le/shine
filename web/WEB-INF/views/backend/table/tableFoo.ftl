...
<head>
    ...
    <link href="/static/backend/css/plugins/footable/footable.core.css" rel="stylesheet">
...
<script src="/static/backend/js/plugins/footable/footable.all.min.js"></script>
