...
<head>
    ...
    <link href="/static/backend/css/plugins/chosen/chosen.css" rel="stylesheet">
    <link href="/static/backend/css/plugins/colorpicker/css/bootstrap-colorpicker.min.css" rel="stylesheet">
    <link href="/static/backend/css/plugins/cropper/cropper.min.css" rel="stylesheet">
    <link href="/static/backend/css/plugins/switchery/switchery.css" rel="stylesheet">
    <link href="/static/backend/css/plugins/jasny/jasny-bootstrap.min.css" rel="stylesheet">
    <link href="/static/backend/css/plugins/nouslider/jquery.nouislider.css" rel="stylesheet">
    <link href="/static/backend/css/plugins/datapicker/datepicker3.css" rel="stylesheet">
    <link href="/static/backend/css/plugins/ionRangeSlider/ion.rangeSlider.css" rel="stylesheet">
    <link href="/static/backend/css/plugins/ionRangeSlider/ion.rangeSlider.skinFlat.css" rel="stylesheet">
    <link href="/static/backend/css/plugins/awesome-bootstrap-checkbox/awesome-bootstrap-checkbox.css" rel="stylesheet">
    <link href="/static/backend/css/plugins/clockpicker/clockpicker.css" rel="stylesheet">
...
<body class="gray-bg">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        ...
                        <div class="ibox-tools">
                            ...
                            <a class="dropdown-toggle" data-toggle="dropdown" href="form_advanced.advanced.ftl#">
                                <i class="fa fa-wrench"></i>
                            </a>
                            <ul class="dropdown-menu dropdown-user">
                                <li><a href="form_advanced.advanced.ftl#">选项1</a>
                                </li>
                                <li><a href="form_advanced.advanced.ftl#">选项2</a>
                                </li>
                            </ul>
                            <a class="close-link">
    ...
    <script src="/static/backend/js/plugins/chosen/chosen.jquery.js"></script>
    <script src="/static/backend/js/plugins/jsKnob/jquery.knob.js"></script>
    <script src="/static/backend/js/plugins/jasny/jasny-bootstrap.min.js"></script>
    <script src="/static/backend/js/plugins/datapicker/bootstrap-datepicker.js"></script>
    <script src="/static/backend/js/plugins/prettyfile/bootstrap-prettyfile.js"></script>
    <script src="/static/backend/js/plugins/nouslider/jquery.nouislider.min.js"></script>
    <script src="/static/backend/js/plugins/switchery/switchery.js"></script>
    <script src="/static/backend/js/plugins/ionRangeSlider/ion.rangeSlider.min.js"></script>
    ...
    <script src="/static/backend/js/plugins/colorpicker/bootstrap-colorpicker.min.js"></script>
    <script src="/static/backend/js/plugins/clockpicker/clockpicker.js"></script>
    <script src="/static/backend/js/plugins/cropper/cropper.min.js"></script>
    <script src="/static/backend/js/demo/form-advanced-demo.min.js"></script>
