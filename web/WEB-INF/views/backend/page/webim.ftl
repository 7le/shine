...
<!-- Mirrored from www.zi-han.net/theme/hplus/webim.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 20 Jan 2016 14:19:48 GMT -->
<head>
                        ...
                        <div class="ibox-content">
                            <ul class="list-group clear-list" style="margin-bottom:0;">
                                ...
                                <li class="list-group-item">
                                    ...
                                    <p>
                                        按照js/plugins/layer/layim/data/的json文件提供的数据接口输出规定的数据格式，注意：如果第二步修改了api的内容，注意输出数据的路径。</p>
