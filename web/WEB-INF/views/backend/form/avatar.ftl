            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <div class="alert alert-info">
                        官网：<a href="http://www.fullavatareditor.com/"
                              target="_blank">http://www.fullavatareditor.com/</a>
                    </div>
...
<script type="text/javascript" src="/static/backend/plugins/fullavatareditor/scripts/swfobject.js"></script>
<script type="text/javascript" src="/static/backend/plugins/fullavatareditor/scripts/fullAvatarEditor.js"></script>
<script type="text/javascript" src="/static/backend/plugins/fullavatareditor/scripts/jQuery.Cookie.js"></script>
<script type="text/javascript" src="/static/backend/plugins/fullavatareditor/scripts/test.js"></script>
