...
<div class="wrapper wrapper-content">
    <div class="row">
        <div class="col-sm-6">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <form action="http://www.zi-han.net/theme/hplus/index_submit" method="get" accept-charset="utf-8"
                          role="form">
                        <hr>
                        <h3>测试(URL 获取)</h3>
            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <article class="markdown-body entry-content" itemprop="mainContentOfPage">
                        ...
                        <h1><a id="user-content-bootstrap-search-suggest" class="anchor"
                               href="#bootstrap-search-suggest" aria-hidden="true"><span
                                class="octicon octicon-link"></span></a>Bootstrap Search Suggest</h1>
                        ...
                        <ul>
                            ...
                            <li>单关键字会设置 data-id 和输入框内容两个值，以 indexId/idField 和 indexKey/idFiled 取值 data
                                的数据为准；多关键字只设置输入框值
                            </li>
                        </ul>
      ...
      url: "/rest/sys/getuserlist?keyword="
                        ...
                        <p>具体使用请参考参数配置说明及demo 示例页面源码(<a
                                href="http://lzw.me/pages/demo/bootstrap-suggest-plugin">Demo</a>)</p>
    ...
    console.log(result);
                        ...
                        <p>onSetSelectValue：当从下拉菜单选取值时触发，并传回设置的数据到第二个参数 onUnsetSelectValue：当设置了
                            idField，且自由输入内容时触发（与背景警告色显示同步）</p>
    ...
    keyEnter: 13                    //回车键
                        ...
                        <h2><a id="user-content-note-on-patches--pull-requests" class="anchor"
                               href="#note-on-patches--pull-requests" aria-hidden="true"><span
                                class="octicon octicon-link"></span></a>Note on Patches / Pull Requests</h2>
                        ...
                        <h2><a id="user-content-设计制作" class="anchor" href="#设计制作" aria-hidden="true"><span
                                class="octicon octicon-link"></span></a>设计制作</h2>
...
<script src="/static/backend/js/plugins/suggest/bootstrap-suggest.min.js"></script>
<script type="text/javascript">
    ...
    var testdataBsSuggest = $("#test_data").bsSuggest({
        ...
        indexKey: 1,
        data: {
            "value": [{"id": "0", "word": "lzw", "description": "http://lzw.me"}, {
                "id": "1",
                "word": "lzwme",
    ...
    var taobaoBsSuggest = $("#taobao").bsSuggest({
        ...
        processData: function (json) {
            ...
            for (i = 0; i < len; i++) {
                data.value.push({"Id": (i + 1), "Keyword": json.result[i][0], "Count": json.result[i][1]})
            }
            console.log(data);
            return data
        }
