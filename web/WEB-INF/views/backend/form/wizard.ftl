...
<head>
    ...
    <link href="/static/backend/css/plugins/steps/jquery.steps.css" rel="stylesheet">
            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools">
                        ...
                        <a class="dropdown-toggle" data-toggle="dropdown" href="form_wizard.wizard.ftl#">
                            <i class="fa fa-wrench"></i>
                        </a>
                        <ul class="dropdown-menu dropdown-user">
                            <li><a href="form_wizard.wizard.ftl#">选项1</a>
                            </li>
                            <li><a href="form_wizard.wizard.ftl#">选项2</a>
                            </li>
                        </ul>
                        <a class="close-link">
...
<script src="/static/backend/js/plugins/staps/jquery.steps.min.js"></script>
<script src="/static/backend/js/plugins/validate/jquery.validate.min.js"></script>
<script src="/static/backend/js/plugins/validate/messages_zh.min.js"></script>
<script>
